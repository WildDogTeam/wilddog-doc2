...
| 26104 | Data requested exceeds the maximum size that can be accessed with a single request | 单次请求数据量过大。请参考 [数据限制](/sync/微信小程序/guide/datalimit.html) ) |
...
| 26108 | App has been frozen | App 停服务。余额不足开通下个月套餐 |
