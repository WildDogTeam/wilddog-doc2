...
其中每个节点都可以设置 [优先级(priority)](/sync/REST/api/Priorities.html)，用于实现节点按优先级排序。
...
具体相关信息，请参考 [API 文档](/sync/REST/api/Streaming.html) 。
...
具体相关信息，请参考：[安全性与规则](/sync/REST/rules/introduce.html) 。