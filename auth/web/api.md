...
`wilddog.auth().createUserWithEmailAndPassword(email, pwd) returns `[wilddog.Promise](/auth/web/api.html#wilddog-Promise)
...
`wilddog.auth().signInAnonymously() returns` [wilddog.Promise](/auth/web/api.html#wilddog-Promise)
...
`wilddog.auth().signInWithEmailAndPassword(email, pwd) returns` [wilddog.Promise](/auth/web/api.html#wilddog-Promise) 
...
`wilddog.auth().signInWithPopup(provider) returns `[wilddog.Promise](/auth/web/api.html#wilddog-Promise)
...
`wilddog.auth().signInWithRedirect(provider) return `[wilddog.Promise](/auth/web/api.html#wilddog-Promise)
...
`wilddog.auth().signInWithCustomToken(token) return` [wilddog.Promise](/auth/web/api.html#wilddog-Promise)
...
`wilddog.auth().sendPasswordResetEmail(email) returns ` [wilddog.Promise](/auth/web/api.html#wilddog-Promise)

* 通过[credential](/auth/web/api.html#Credential)登录

`wilddog.auth().signInWithCredential(credential) returns`
[wilddog.Promise](/auth/web/api.html#wilddog-Promise)
